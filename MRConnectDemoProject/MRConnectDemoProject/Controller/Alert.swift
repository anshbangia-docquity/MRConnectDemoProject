...
struct AlertManager {
    ...
    private func showAlert(title: String, subtitle: String) -> UIAlertController {
    ...
    func showAlert(on vc: UIViewController, text: (String, String)) {
        vc.present(showAlert(title: text.0, subtitle: text.1), animated: true, completion: nil)
    }
